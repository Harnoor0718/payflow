...
function Dashboard() {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-6">
      <div className="bg-white border-2 border-black rounded-lg p-3 sm:p-4 hover:scale-105 transition-transform duration-200">
        <div className="text-xl sm:text-2xl font-bold text-black">{stats.total}</div>
        <div className="text-xs sm:text-sm text-gray-600">Total</div>
      </div>
      
      <div className="bg-purple-50 border-2 border-purple-300 rounded-lg p-3 sm:p-4 hover:scale-105 transition-transform duration-200">
      ...
      <div className="bg-green-50 border-2 border-green-300 rounded-lg p-3 sm:p-4 hover:scale-105 transition-transform duration-200">
      ...
      <div className="bg-red-50 border-2 border-red-300 rounded-lg p-3 sm:p-4 hover:scale-105 transition-transform duration-200">
      ...
      <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg p-3 sm:p-4 hover:scale-105 transition-transform duration-200">
